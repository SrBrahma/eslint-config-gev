// The complete eslintrc from a react native project of mine. For future references.
...
module.exports = {
  ...
  "rules": {
    ...
    "semi": ["warn", "always"],
    "comma-spacing": ["warn"],
    "array-bracket-spacing": ["warn", "never"], // may/should be specified the cases https://eslint.org/docs/rules/space-in-brackets#exceptions
